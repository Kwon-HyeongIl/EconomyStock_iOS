...
struct LottieView: View {
    ...
    var body: some View {
        VStack {
            LottieViewMain(url: Bundle.main.url(forResource: fileName, withExtension: "lottie")!, fileName: fileName, loopMode: loopMode, fromProgress: fromProgress, toProgress: toProgress, speed: speed)
