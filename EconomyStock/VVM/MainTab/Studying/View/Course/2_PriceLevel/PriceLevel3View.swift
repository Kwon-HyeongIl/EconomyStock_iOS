                                    ...
                                    if contentText1_2 {
                                        ...
                                        if contentImage1 {
                                            ZStack {
                                                HStack {
                                                    VStack(spacing: 0) {
                                                        LottieView(fileName: "BubbleHeart", loopMode: .playOnce, scale: 2.0, width: 40, height: 40)
                                                    ...
                                                    LottieView(fileName: "PriceLevel3_PriceDown", loopMode: .playOnce, scale: 1.3, width: 150, height: 150)
                                                }
                                                .opacity(progress.count >= 2 ? 0.4 : 1.0)
                                                
                                                if progress.count >= 2 {
                                                    LottieView(fileName: "Warning", loopMode: .playOnce, scale: 1.3, width: 120, height: 120)
                                                }
                                            }
                                        }
                                    }
                                ...
                                VStack(spacing: 0) {
                                    ...
                                    if questionMarkContent {
                                        HStack(spacing: 5) {
                                            ...
                                            Text("경기침체는 경제 내에서 생산이 적정 수준보다 과소하게 이루어지는 현상을 말해요, 이 때 실업률이 상승하고, 국민 소득이 감소하며 물가가 크게 하락하는 특징이 있어요.")
                                                .font(.system(size: 15))
                                                .fontWeight(.semibold)
                                                .foregroundStyle(.black.opacity(0.6))
                                                .padding(.bottom, 10)
