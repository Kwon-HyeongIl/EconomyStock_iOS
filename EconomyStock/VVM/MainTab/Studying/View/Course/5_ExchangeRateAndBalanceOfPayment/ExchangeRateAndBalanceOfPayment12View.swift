//
//  ExchangeRateAndBalanceOfPayment12View.swift
//  EconomyStock
//
...
struct ExchangeRateAndBalanceOfPayment12View: View {
...
#Preview {
    ExchangeRateAndBalanceOfPayment12View(viewModel: CourseViewModel(course: Course.DUMMY_COURSE))
