...
struct MoneyAndFinance4View: View {
                ...
                ZStack {
                    ScrollView {
                        ...
                        ZStack {
                            if nextScrollPart {
                                VStack {
                                    (Text("경제 내의 통화량이 증가하면 돈의 가치가 하락하게 되며, 이것은 ")
                                     + Text("이자율을 하락")
                                        .foregroundStyle(Color.ESTitle)
                                        .fontWeight(.bold)
                                     + Text("시켜요"))
                                    ...
                                    if contentImage2 {
                                        LottieView(fileName: "MoneyAndFinance4_PercentDown", loopMode: .playOnce, width: 150, height: 150)
                                    }
...
#Preview {
    MoneyAndFinance4View(viewModel: CourseViewModel(course: Course.DUMMY_COURSE))
