...
struct MoneyAndFinance10View: View {
                ...
                ZStack {
                    ScrollView {
                        ...
                        ZStack {
                            if progress.count >= 1 {
                                VStack {
                                    ...
                                    if contentText2_2 {
                                        Text("중앙은행이 채권을 사거나 팜으로써 통화량을 조절하는 방법이에요")
                                            .font(.system(size: 20))
                                            .fontWeight(.semibold)
                                            .multilineTextAlignment(.center)
                                            .padding(.horizontal)
                        ...
                        ZStack {
                            if nextScrollPart {
                                VStack {
                                    (Text("중앙은행이 시중의 채권을 사게 되면 중앙은행이 보유한 돈이 시중에 흘러들어감으로써 경제 내의 ")
                                    + Text("통화량은 증가")
                                        .foregroundStyle(Color.ESTitle)
                                        .fontWeight(.bold)
                                    + Text("해요"))
                                    ...
                                    if contentText3_2 {
                                        (Text("또한, 중앙은행이 시중의 채권을 팔게 되면 시중의 돈이 중앙은행에게 흘러들어가 ")
                                        + Text("통화량은 감소")
                                            .foregroundStyle(Color.ESTitle)
                                            .fontWeight(.bold)
                                        + Text("해요"))
...
#Preview {
    MoneyAndFinance10View(viewModel: CourseViewModel(course: Course.DUMMY_COURSE))
